...
const cat6 = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/about-me' : `/category/about-me/${currentPage - 1}`
    const nextPage = `/category/about-me/${currentPage + 1}`

    return (
        <Layout>
            <SEO title='About Aayush Saini' keywords={['aayush', 'aayush saini', 'saini', 'ayush', 'ayush saini', 'mountains', 'India', 'nature', 'life', 'travelblog', 'lifestyle', 'programmer']} />
            <Nav />
            <header>
...
query cat6Query ($skip: Int!, $limit: Int!){
    allContentfulBlog(
