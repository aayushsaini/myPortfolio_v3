...
const cat2 = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/artificial-intelligence' : `/category/artificial-intelligence/${currentPage - 1}`
    const nextPage = `/category/artificial-intelligence/${currentPage + 1}`

    return (
        <Layout>
            <SEO title='Artificial Intelligence' keywords={['aayush', 'aayush saini', 'saini', 'ayush', 'ayush saini', 'programming', 'computer science', 'web', 'design', 'development', 'html', 'css', 'html5', 'css3', 'js', 'javascript', 'web design', 'web developer', 'ai', 'ml', 'dl', 'artificial intelligence', 'life', 'travelblog', 'lifestyle', 'programmer']} />
            <Nav />
            <header>
...
query cat2Query ($skip: Int!, $limit: Int!){
    allContentfulBlog(
