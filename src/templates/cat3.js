...
const cat3 = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/ui-ux-design' : `/category/ui-ux-design/${currentPage - 1}`
    const nextPage = `/category/ui-ux-design/${currentPage + 1}`

    return (
        <Layout>
            <SEO title='UI/UX Projects' keywords={['aayush', 'aayush saini', 'saini', 'ayush', 'ayush saini', 'programming', 'computer science', 'web', 'design', 'development', 'html', 'css', 'html5', 'css3', 'js', 'javascript', 'web design', 'web developer', 'ui', 'ux', 'ui/ux', 'ui design', 'ui concept', 'life', 'travelblog', 'lifestyle', 'programmer']} />
            <Nav />
            <header>
...
query cat3Query ($skip: Int!, $limit: Int!){
    allContentfulBlog(
