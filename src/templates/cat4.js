...
const cat4 = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/others' : `/category/others/${currentPage - 1}`
    const nextPage = `/category/others/${currentPage + 1}`

    return (
        <Layout>
            <SEO title='Aayush Saini projects' keywords={['aayush', 'aayush saini', 'saini', 'ayush', 'ayush saini', 'programming', 'computer science', 'web', 'design', 'development', 'html', 'css', 'html5', 'css3', 'js', 'javascript', 'web design', 'web developer', 'ai', 'ml', 'dl', 'artificial intelligence', 'life', 'travelblog', 'lifestyle', 'programmer']} />
            <Nav />
            <header>
...
query cat4Query ($skip: Int!, $limit: Int!){
    allContentfulBlog(
