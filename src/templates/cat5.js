...
const cat5 = (props) => {
    ...
    return (
        <Layout>
            <SEO title='Aayush Saini Life' keywords={['aayush', 'aayush saini', 'saini', 'ayush', 'ayush saini', 'mountains', 'India', 'nature', 'life', 'travelblog', 'lifestyle', 'programmer']} />
            <Nav />
            <header>
...
query cat5Query ($skip: Int!, $limit: Int!){
    allContentfulBlog(
