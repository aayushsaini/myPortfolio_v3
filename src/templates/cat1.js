...
const cat1 = (props) => {
    ...
    const prevPage = currentPage - 1 === 1 ? '/category/web-development' : `/category/web-development/${currentPage - 1}`
    const nextPage = `/category/web-development/${currentPage + 1}`

    return (
        <Layout>
            <SEO title='Websites' keywords={['aayush', 'aayush saini', 'saini', 'ayush', 'ayush saini', 'programming', 'computer science', 'web', 'design', 'development', 'html', 'css', 'html5', 'css3', 'js', 'javascript', 'web design', 'web developer', 'ai', 'ml', 'dl', 'artificial intelligence', 'life', 'travelblog', 'lifestyle', 'programmer']} />
            <Nav />
            <header>
...
query cat1Query ($skip: Int!, $limit: Int!){
    allContentfulBlog(
